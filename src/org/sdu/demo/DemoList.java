package org.sdu.demo;

import java.util.ArrayList;
import java.util.List;

import org.sdu.demo.gameText.GameTest;
 ...
 * 
 * @author Joycery & Sww Map Scene etc
 * @author Misshooooo Drawable Sprite etc
 * @author yes_coffee Util SImage Database MultiPointsTools etc
 * @author yyt Util Shaps Media etc
 * @author shadow Activity UI etc
 */
public class DemoList extends ListActivity {
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		// 接着else if (num.equals("号"))
			...
			Toast.makeText(getApplicationContext(), "开发ing 请期待",
